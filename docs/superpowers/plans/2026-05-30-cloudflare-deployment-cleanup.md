...
- **Cloudflare dry run**: `pnpm deploy:dry-run` (OpenNext build + Wrangler dry-run packaging)
- **Smoke test**: `SMOKE_BASE_URL=http://localhost:8788 pnpm smoke`
```
...
SMOKE_BASE_URL=http://localhost:8788 pnpm smoke
