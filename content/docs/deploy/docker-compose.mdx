...
- set `MEMOS_INSTANCE_URL` to the canonical external URL and configure private or public access separately through the [ACCESS setting](/docs/configuration/deployment-configuration#access-policy)
