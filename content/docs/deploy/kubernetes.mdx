...
- `MEMOS_INSTANCE_URL` set to the canonical external URL, with private or public access selected separately through the [ACCESS setting](/docs/configuration/deployment-configuration#access-policy)
