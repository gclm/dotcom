...
- select private access in the `ACCESS` instance setting when anonymous public access is not intended
- set `MEMOS_INSTANCE_URL` to the canonical URL used by your reverse proxy; changing this URL does not change access policy
