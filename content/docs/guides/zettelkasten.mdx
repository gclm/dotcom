...
relatedPages: ["/docs/usage/memos", "/docs/usage/tags", "/docs/usage/saved-views", "/docs/usage/search-archive", "/docs/guides/getting-things-done"]
---
...
A second [saved filter](/docs/usage/saved-views) can surface recent Zettelkasten memos for a connection pass:
