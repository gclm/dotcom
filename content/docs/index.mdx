---
title: Documentation
description: Official Memos documentation — install and self-host with Docker, configure storage and authentication, use the API, and master daily Markdown note-taking.
---

Memos is a self-hosted note-taking and knowledge base system built around plain-text Markdown, flexible visibility controls, and lightweight deployment. Start with the quickstart, then move into deployment, configuration, and daily use.

The usage and configuration guides include changes introduced in **0.31.0-rc.1**. This is a release candidate; stable installation examples continue to use the stable image. Read the [0.31 upgrade notes](/docs/operations/upgrade#upgrading-to-031) before testing the candidate. The API reference provides separate version selections.
...
<Cards>
  ...
  <Card title="Webhooks" href="/docs/integrations/webhooks" icon="Link">
    Connect Memos to the rest of your stack with event-driven automation.
  </Card>
</Cards>
...
<Cards>
  ...
  <Card title="Usage" href="/docs/usage" icon="FileText">
    Write memos in Markdown, organize with tags, and work faster with saved views.
  </Card>
  <Card title="Guides" href="/docs/guides" icon="Map">
    Explore Bullet Journal, GTD, and Zettelkasten in Memos.
  </Card>
  <Card title="Integrations" href="/docs/integrations" icon="Puzzle">
    API access, MCP, webhooks, and community tools.
  </Card>
