...
| --- | --- |
| Saved Views | Replace `ShortcutService` with `MemoViewService`, shortcut resources with view resources, and `/api/v1/users/*/shortcuts/*` with `/api/v1/users/*/views/*`. Stored filters migrate automatically. |
