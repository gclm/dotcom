...
In private mode, ordinary `PUBLIC` memo pages still require sign-in. Explicit share links remain accessible without sign-in until revoked or expired. `SPACE` memos cannot have share links. Placement and visibility are independent; see [Spaces](/docs/usage/spaces).
...
- [Spaces](/docs/usage/spaces)
- [Saved Views](/docs/usage/saved-views)
...
- For version-specific changes, read [Upgrading to 0.31](/docs/operations/upgrade#upgrading-to-031).
