...
The resizable sidebar contains the calendar, Saved Views, tags, Quick Find, and navigation for the current route. Open the global composer from the sidebar to write without returning to Home.
