...
Memos also supports richer filtering beyond plain text search. Saved filters and saved views can combine tags with memo properties.
...
- use [saved views](/docs/usage/saved-views) to save filters you run often
